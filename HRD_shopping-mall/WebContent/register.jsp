...
<tr>
<td>회원번호(자동발생)</td>
<td><input type="text" readonly="readonly" value="<%=maxno%>" class="js-custno"></td>
</tr>
<tr>
<td>회원성명</td>
...
<tr>
<td>가입일자</td>
<td><input type="text" value="<%=disp%>" class="js-joindate"></td>
</tr>
<tr>
<td>고객등급(A:VIP,B:일반,C:직원)</td>
<td><input type="text" class="js-grade"></td>
</tr>
<tr>
<td>도시코드</td>
<td><input type="text" class="js-city"></td>
</tr>
<tr>
<td colspan="2">
